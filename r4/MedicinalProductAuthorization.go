...
func (resource *MedicinalProductAuthorization) T_Country(optionsValueSet []Coding) templ.Component {
...
func (resource *MedicinalProductAuthorization) T_Jurisdiction(optionsValueSet []Coding) templ.Component {
...
func (resource *MedicinalProductAuthorization) T_JurisdictionalAuthorizationJurisdiction(numJurisdictionalAuthorization int, optionsValueSet []Coding) templ.Component {
