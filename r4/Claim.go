...
func (resource *Claim) T_CareTeamQualification(numCareTeam int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.CareTeam) >= numCareTeam {
		return CodeableConceptSelect("Claim.CareTeam["+strconv.Itoa(numCareTeam)+"].Qualification", nil, optionsValueSet)
	}
	return CodeableConceptSelect("Claim.CareTeam["+strconv.Itoa(numCareTeam)+"].Qualification", resource.CareTeam[numCareTeam].Qualification, optionsValueSet)
}
...
func (resource *Claim) T_DiagnosisPackageCode(numDiagnosis int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.Diagnosis) >= numDiagnosis {
		return CodeableConceptSelect("Claim.Diagnosis["+strconv.Itoa(numDiagnosis)+"].PackageCode", nil, optionsValueSet)
	}
	return CodeableConceptSelect("Claim.Diagnosis["+strconv.Itoa(numDiagnosis)+"].PackageCode", resource.Diagnosis[numDiagnosis].PackageCode, optionsValueSet)
}
...
func (resource *Claim) T_ItemBodySite(numItem int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.Item) >= numItem {
		return CodeableConceptSelect("Claim.Item["+strconv.Itoa(numItem)+"].BodySite", nil, optionsValueSet)
	}
	return CodeableConceptSelect("Claim.Item["+strconv.Itoa(numItem)+"].BodySite", resource.Item[numItem].BodySite, optionsValueSet)
}
func (resource *Claim) T_ItemSubSite(numItem int, numSubSite int, optionsValueSet []Coding) templ.Component {

	if resource == nil || len(resource.Item) >= numItem || len(resource.Item[numItem].SubSite) >= numSubSite {
		return CodeableConceptSelect("Claim.Item["+strconv.Itoa(numItem)+"].SubSite["+strconv.Itoa(numSubSite)+"]", nil, optionsValueSet)
	}
	return CodeableConceptSelect("Claim.Item["+strconv.Itoa(numItem)+"].SubSite["+strconv.Itoa(numSubSite)+"]", &resource.Item[numItem].SubSite[numSubSite], optionsValueSet)
}
