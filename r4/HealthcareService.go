...
func (resource *HealthcareService) T_Telecom(numTelecom int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *HealthcareService) T_AvailabilityExceptions(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *HealthcareService) T_AvailableTimeDaysOfWeek(numAvailableTime int, numDaysOfWeek int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *HealthcareService) T_AvailableTimeAllDay(numAvailableTime int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *HealthcareService) T_AvailableTimeAvailableStartTime(numAvailableTime int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAvailableTime >= len(resource.AvailableTime) {
...
func (resource *HealthcareService) T_AvailableTimeAvailableEndTime(numAvailableTime int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAvailableTime >= len(resource.AvailableTime) {
...
func (resource *HealthcareService) T_NotAvailableDescription(numNotAvailable int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *HealthcareService) T_NotAvailableDuring(numNotAvailable int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numNotAvailable >= len(resource.NotAvailable) {
