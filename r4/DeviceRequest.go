...
func (resource *DeviceRequest) T_CodeCodeableConcept(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodeableConceptSelect("DeviceRequest.CodeCodeableConcept", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("DeviceRequest.CodeCodeableConcept", &resource.CodeCodeableConcept, optionsValueSet, htmlAttrs)
}
...
func (resource *DeviceRequest) T_PerformerType(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodeableConceptSelect("DeviceRequest.PerformerType", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("DeviceRequest.PerformerType", resource.PerformerType, optionsValueSet, htmlAttrs)
}
func (resource *DeviceRequest) T_ReasonCode(numReasonCode int, optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil || numReasonCode >= len(resource.ReasonCode) {
		return CodeableConceptSelect("DeviceRequest.ReasonCode."+strconv.Itoa(numReasonCode)+".", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("DeviceRequest.ReasonCode."+strconv.Itoa(numReasonCode)+".", &resource.ReasonCode[numReasonCode], optionsValueSet, htmlAttrs)
}
