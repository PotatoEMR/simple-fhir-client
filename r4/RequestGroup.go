...
func (resource *RequestGroup) T_ReasonCode(optionsValueSet []Coding) templ.Component {
...
func (resource *RequestGroup) T_ActionCode(numAction int, optionsValueSet []Coding) templ.Component {
