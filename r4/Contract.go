...
// http://hl7.org/fhir/r4/StructureDefinition/Contract
...
func (resource *Contract) T_ContentDefinitionType(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("ContentDefinitionType", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("ContentDefinitionType", &resource.ContentDefinition.Type, optionsValueSet, htmlAttrs)
}
func (resource *Contract) T_ContentDefinitionSubType(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("ContentDefinitionSubType", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("ContentDefinitionSubType", resource.ContentDefinition.SubType, optionsValueSet, htmlAttrs)
}
func (resource *Contract) T_ContentDefinitionPublicationDate(htmlAttrs string) templ.Component {
	if resource == nil {
		return DateTimeInput("ContentDefinitionPublicationDate", nil, htmlAttrs)
	}
	return DateTimeInput("ContentDefinitionPublicationDate", resource.ContentDefinition.PublicationDate, htmlAttrs)
}
func (resource *Contract) T_ContentDefinitionPublicationStatus(htmlAttrs string) templ.Component {
	...
	if resource == nil {
		return CodeSelect("ContentDefinitionPublicationStatus", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("ContentDefinitionPublicationStatus", &resource.ContentDefinition.PublicationStatus, optionsValueSet, htmlAttrs)
}
func (resource *Contract) T_ContentDefinitionCopyright(htmlAttrs string) templ.Component {
	if resource == nil {
		return StringInput("ContentDefinitionCopyright", nil, htmlAttrs)
	}
	return StringInput("ContentDefinitionCopyright", resource.ContentDefinition.Copyright, htmlAttrs)
}
