...
func (resource *Contract) T_TermActionReasonCode(numTerm int, numAction int, numReasonCode int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	...
	if resource == nil || numTerm >= len(resource.Term) || numAction >= len(resource.Term[numTerm].Action) || numReasonCode >= len(resource.Term[numTerm].Action[numAction].ReasonCode) {
		return CodeableConceptSelect("Contract.Term."+strconv.Itoa(numTerm)+"..Action."+strconv.Itoa(numAction)+"..ReasonCode."+strconv.Itoa(numReasonCode)+".", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("Contract.Term."+strconv.Itoa(numTerm)+"..Action."+strconv.Itoa(numAction)+"..ReasonCode."+strconv.Itoa(numReasonCode)+".", &resource.Term[numTerm].Action[numAction].ReasonCode[numReasonCode], optionsValueSet, htmlAttrs)
}
func (resource *Contract) T_TermActionReason(numTerm int, numAction int, numReason int, htmlAttrs string) templ.Component {
	...
	if resource == nil || numTerm >= len(resource.Term) || numAction >= len(resource.Term[numTerm].Action) || numReason >= len(resource.Term[numTerm].Action[numAction].Reason) {
		return StringInput("Contract.Term."+strconv.Itoa(numTerm)+"..Action."+strconv.Itoa(numAction)+"..Reason."+strconv.Itoa(numReason)+".", nil, htmlAttrs)
	}
	return StringInput("Contract.Term."+strconv.Itoa(numTerm)+"..Action."+strconv.Itoa(numAction)+"..Reason."+strconv.Itoa(numReason)+".", &resource.Term[numTerm].Action[numAction].Reason[numReason], htmlAttrs)
}
