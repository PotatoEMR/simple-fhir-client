...
func (resource *Task) T_ReasonReference(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ReferenceInput("reasonReference", nil, htmlAttrs)
	}
	return ReferenceInput("reasonReference", resource.ReasonReference, htmlAttrs)
}
