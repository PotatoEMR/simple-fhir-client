...
func (resource *SubstanceSpecification) T_StructureIsotopeName(numIsotope int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numIsotope >= len(resource.Structure.Isotope) {
		return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].Name", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].Name", resource.Structure.Isotope[numIsotope].Name, optionsValueSet, htmlAttrs)
}
func (resource *SubstanceSpecification) T_StructureIsotopeSubstitution(numIsotope int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numIsotope >= len(resource.Structure.Isotope) {
		return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].Substitution", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].Substitution", resource.Structure.Isotope[numIsotope].Substitution, optionsValueSet, htmlAttrs)
}
func (resource *SubstanceSpecification) T_StructureIsotopeMolecularWeightMethod(numIsotope int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numIsotope >= len(resource.Structure.Isotope) {
		return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].MolecularWeight.Method", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].MolecularWeight.Method", resource.Structure.Isotope[numIsotope].MolecularWeight.Method, optionsValueSet, htmlAttrs)
}
func (resource *SubstanceSpecification) T_StructureIsotopeMolecularWeightType(numIsotope int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numIsotope >= len(resource.Structure.Isotope) {
		return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].MolecularWeight.Type", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("StructureIsotope["+strconv.Itoa(numIsotope)+"].MolecularWeight.Type", resource.Structure.Isotope[numIsotope].MolecularWeight.Type, optionsValueSet, htmlAttrs)
}
