...
templ DateInput(fieldname string, current *FhirDate, attrs templ.Attributes) {
	if current == nil {
...
templ DateTimeInput(fieldname string, current *FhirDateTime, attrs templ.Attributes) {
	if current == nil {
