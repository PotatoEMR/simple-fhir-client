...
templ DateInput(fieldname string, current *string, htmlAttrs string) {
	if current == nil {
		<input type="date" name={fieldname} value=""/>
	} else {
		<input type="date" name={fieldname} value={*current}/>
	}
}

templ DateTimeInput(fieldname string, current *string, htmlAttrs string) {
	if current == nil {
		<input type="datetime-local" name={fieldname} value=""/>
	} else {
		<input type="datetime-local" name={fieldname} value={*current}/>
	}
}
