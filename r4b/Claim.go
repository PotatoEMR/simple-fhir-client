...
func (resource *Claim) ClaimCareTeamQualification(numCareTeam int, optionsValueSet []Coding) templ.Component {
...
func (resource *Claim) ClaimDiagnosisPackageCode(numDiagnosis int, optionsValueSet []Coding) templ.Component {
...
func (resource *Claim) ClaimItemBodySite(numItem int, optionsValueSet []Coding) templ.Component {
...
func (resource *Claim) ClaimItemSubSite(numItem int, optionsValueSet []Coding) templ.Component {
