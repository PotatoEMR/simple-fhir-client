...
func (resource *Encounter) T_HospitalizationAdmitSource(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("HospitalizationAdmitSource", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("HospitalizationAdmitSource", resource.Hospitalization.AdmitSource, optionsValueSet, htmlAttrs)
}
func (resource *Encounter) T_HospitalizationReAdmission(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("HospitalizationReAdmission", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("HospitalizationReAdmission", resource.Hospitalization.ReAdmission, optionsValueSet, htmlAttrs)
}
func (resource *Encounter) T_HospitalizationDietPreference(numDietPreference int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numDietPreference >= len(resource.Hospitalization.DietPreference) {
		return CodeableConceptSelect("HospitalizationDietPreference["+strconv.Itoa(numDietPreference)+"]", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("HospitalizationDietPreference["+strconv.Itoa(numDietPreference)+"]", &resource.Hospitalization.DietPreference[numDietPreference], optionsValueSet, htmlAttrs)
}
func (resource *Encounter) T_HospitalizationSpecialCourtesy(numSpecialCourtesy int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numSpecialCourtesy >= len(resource.Hospitalization.SpecialCourtesy) {
		return CodeableConceptSelect("HospitalizationSpecialCourtesy["+strconv.Itoa(numSpecialCourtesy)+"]", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("HospitalizationSpecialCourtesy["+strconv.Itoa(numSpecialCourtesy)+"]", &resource.Hospitalization.SpecialCourtesy[numSpecialCourtesy], optionsValueSet, htmlAttrs)
}
func (resource *Encounter) T_HospitalizationSpecialArrangement(numSpecialArrangement int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numSpecialArrangement >= len(resource.Hospitalization.SpecialArrangement) {
		return CodeableConceptSelect("HospitalizationSpecialArrangement["+strconv.Itoa(numSpecialArrangement)+"]", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("HospitalizationSpecialArrangement["+strconv.Itoa(numSpecialArrangement)+"]", &resource.Hospitalization.SpecialArrangement[numSpecialArrangement], optionsValueSet, htmlAttrs)
}
func (resource *Encounter) T_HospitalizationDischargeDisposition(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("HospitalizationDischargeDisposition", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("HospitalizationDischargeDisposition", resource.Hospitalization.DischargeDisposition, optionsValueSet, htmlAttrs)
}
