...
func (resource *MolecularSequence) T_ReferenceSeqChromosome(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("ReferenceSeqChromosome", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("ReferenceSeqChromosome", resource.ReferenceSeq.Chromosome, optionsValueSet, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqGenomeBuild(htmlAttrs string) templ.Component {
	if resource == nil {
		return StringInput("ReferenceSeqGenomeBuild", nil, htmlAttrs)
	}
	return StringInput("ReferenceSeqGenomeBuild", resource.ReferenceSeq.GenomeBuild, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqOrientation(htmlAttrs string) templ.Component {
	...
	if resource == nil {
		return CodeSelect("ReferenceSeqOrientation", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("ReferenceSeqOrientation", resource.ReferenceSeq.Orientation, optionsValueSet, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqReferenceSeqId(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodeableConceptSelect("ReferenceSeqReferenceSeqId", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("ReferenceSeqReferenceSeqId", resource.ReferenceSeq.ReferenceSeqId, optionsValueSet, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqReferenceSeqString(htmlAttrs string) templ.Component {
	if resource == nil {
		return StringInput("ReferenceSeqReferenceSeqString", nil, htmlAttrs)
	}
	return StringInput("ReferenceSeqReferenceSeqString", resource.ReferenceSeq.ReferenceSeqString, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqStrand(htmlAttrs string) templ.Component {
	optionsValueSet := VSStrand_type

	if resource == nil {
		return CodeSelect("ReferenceSeqStrand", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("ReferenceSeqStrand", resource.ReferenceSeq.Strand, optionsValueSet, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqWindowStart(htmlAttrs string) templ.Component {
	if resource == nil {
		return IntInput("ReferenceSeqWindowStart", nil, htmlAttrs)
	}
	return IntInput("ReferenceSeqWindowStart", resource.ReferenceSeq.WindowStart, htmlAttrs)
}
func (resource *MolecularSequence) T_ReferenceSeqWindowEnd(htmlAttrs string) templ.Component {
	if resource == nil {
		return IntInput("ReferenceSeqWindowEnd", nil, htmlAttrs)
	}
	return IntInput("ReferenceSeqWindowEnd", resource.ReferenceSeq.WindowEnd, htmlAttrs)
}
