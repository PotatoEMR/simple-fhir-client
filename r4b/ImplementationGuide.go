...
func (resource *ImplementationGuide) T_DefinitionResourceExampleBoolean(numResource int, htmlAttrs string) templ.Component {
	if resource == nil || numResource >= len(resource.Definition.Resource) {
		return BoolInput("DefinitionResource["+strconv.Itoa(numResource)+"].ExampleBoolean", nil, htmlAttrs)
	}
	return BoolInput("DefinitionResource["+strconv.Itoa(numResource)+"].ExampleBoolean", resource.Definition.Resource[numResource].ExampleBoolean, htmlAttrs)
}
func (resource *ImplementationGuide) T_DefinitionResourceExampleCanonical(numResource int, htmlAttrs string) templ.Component {
	if resource == nil || numResource >= len(resource.Definition.Resource) {
		return StringInput("DefinitionResource["+strconv.Itoa(numResource)+"].ExampleCanonical", nil, htmlAttrs)
	}
	return StringInput("DefinitionResource["+strconv.Itoa(numResource)+"].ExampleCanonical", resource.Definition.Resource[numResource].ExampleCanonical, htmlAttrs)
}
...
func (resource *ImplementationGuide) T_DefinitionPageNameUrl(htmlAttrs string) templ.Component {
	if resource == nil {
		return StringInput("DefinitionPage.NameUrl", nil, htmlAttrs)
	}
	return StringInput("DefinitionPage.NameUrl", &resource.Definition.Page.NameUrl, htmlAttrs)
}
...
func (resource *ImplementationGuide) T_DefinitionParameterCode(numParameter int, htmlAttrs string) templ.Component {
	...
	if resource == nil || numParameter >= len(resource.Definition.Parameter) {
		return CodeSelect("DefinitionParameter["+strconv.Itoa(numParameter)+"].Code", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("DefinitionParameter["+strconv.Itoa(numParameter)+"].Code", &resource.Definition.Parameter[numParameter].Code, optionsValueSet, htmlAttrs)
}
...
func (resource *ImplementationGuide) T_ManifestResourceExampleBoolean(numResource int, htmlAttrs string) templ.Component {
	if resource == nil || numResource >= len(resource.Manifest.Resource) {
		return BoolInput("ManifestResource["+strconv.Itoa(numResource)+"].ExampleBoolean", nil, htmlAttrs)
	}
	return BoolInput("ManifestResource["+strconv.Itoa(numResource)+"].ExampleBoolean", resource.Manifest.Resource[numResource].ExampleBoolean, htmlAttrs)
}
func (resource *ImplementationGuide) T_ManifestResourceExampleCanonical(numResource int, htmlAttrs string) templ.Component {
	if resource == nil || numResource >= len(resource.Manifest.Resource) {
		return StringInput("ManifestResource["+strconv.Itoa(numResource)+"].ExampleCanonical", nil, htmlAttrs)
	}
	return StringInput("ManifestResource["+strconv.Itoa(numResource)+"].ExampleCanonical", resource.Manifest.Resource[numResource].ExampleCanonical, htmlAttrs)
}
