...
func (resource *NutritionOrder) T_SupplementType(numSupplement int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.Supplement) >= numSupplement {
		return CodeableConceptSelect("NutritionOrder.Supplement["+strconv.Itoa(numSupplement)+"].Type", nil, optionsValueSet)
	}
	return CodeableConceptSelect("NutritionOrder.Supplement["+strconv.Itoa(numSupplement)+"].Type", resource.Supplement[numSupplement].Type, optionsValueSet)
}
...
func (resource *NutritionOrder) T_EnteralFormulaBaseFormulaType(optionsValueSet []Coding) templ.Component {
	...
	if resource == nil {
		return CodeableConceptSelect("NutritionOrder.EnteralFormula.BaseFormulaType", nil, optionsValueSet)
	}
	return CodeableConceptSelect("NutritionOrder.EnteralFormula.BaseFormulaType", resource.EnteralFormula.BaseFormulaType, optionsValueSet)
}
...
func (resource *NutritionOrder) T_EnteralFormulaAdditiveType(optionsValueSet []Coding) templ.Component {
	...
	if resource == nil {
		return CodeableConceptSelect("NutritionOrder.EnteralFormula.AdditiveType", nil, optionsValueSet)
	}
	return CodeableConceptSelect("NutritionOrder.EnteralFormula.AdditiveType", resource.EnteralFormula.AdditiveType, optionsValueSet)
}
func (resource *NutritionOrder) T_EnteralFormulaAdditiveProductName() templ.Component {

	if resource == nil {
		return StringInput("NutritionOrder.EnteralFormula.AdditiveProductName", nil)
	}
	return StringInput("NutritionOrder.EnteralFormula.AdditiveProductName", resource.EnteralFormula.AdditiveProductName)
}
