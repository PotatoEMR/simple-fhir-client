...
func (resource *ImagingStudy) T_Interpreter(frs []FhirResource, numInterpreter int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ImagingStudy) T_ProcedureReference(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ReferenceInput(frs, "procedureReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "procedureReference", resource.ProcedureReference, htmlAttrs)
}
...
func (resource *ImagingStudy) T_ReasonReference(frs []FhirResource, numReasonReference int, htmlAttrs templ.Attributes) templ.Component {
