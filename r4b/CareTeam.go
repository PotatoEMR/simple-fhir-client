...
func (resource *CareTeam) CareTeamReasonCode(optionsValueSet []Coding) templ.Component {
...
func (resource *CareTeam) CareTeamParticipantRole(numParticipant int, optionsValueSet []Coding) templ.Component {
	...
	return CodeableConceptSelect("role", &resource.Participant[numParticipant].Role[0], optionsValueSet)
}
