...
func (resource *Citation) T_RelatesToTargetClassifier(numRelatesTo int, optionsValueSet []Coding) templ.Component {
...
func (resource *Citation) T_CitedArtifactRelatesToTargetClassifier(numRelatesTo int, optionsValueSet []Coding) templ.Component {
