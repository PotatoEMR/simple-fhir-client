...
func Search[T SearchParam](sp T, fc *FhirClient) (*r4.Bundle, error) {
...
func (fc *FhirClient) PatientEverything(patId string) (*r4.Bundle, error) {
...
func makeRequestCheckError(fc *FhirClient, req *http.Request) (*http.Response, error) {
	...
	if resp.StatusCode >= 300 {
		var opOutcome r4.OperationOutcome
