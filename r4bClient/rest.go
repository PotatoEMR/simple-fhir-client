...
func Search[T SearchParam](sp T, fc *FhirClient) (*r4b.Bundle, error) {
...
func (fc *FhirClient) PatientEverything(patId string) (*r4b.Bundle, error) {
...
func makeRequestCheckError(fc *FhirClient, req *http.Request) (*http.Response, error) {
	...
	if resp.StatusCode >= 300 {
		var opOutcome r4b.OperationOutcome
