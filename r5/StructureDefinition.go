...
func (resource *StructureDefinition) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("StructureDefinition.CopyrightLabel", nil)
	}
	return StringInput("StructureDefinition.CopyrightLabel", resource.CopyrightLabel)
}
