...
func (resource *StructureDefinition) T_VersionAlgorithmString(htmlAttrs string) templ.Component {
	...
	if resource == nil {
		return StringInput("StructureDefinition.VersionAlgorithmString", nil, htmlAttrs)
	}
	return StringInput("StructureDefinition.VersionAlgorithmString", resource.VersionAlgorithmString, htmlAttrs)
}
func (resource *StructureDefinition) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodingSelect("StructureDefinition.VersionAlgorithmCoding", nil, optionsValueSet, htmlAttrs)
	}
	return CodingSelect("StructureDefinition.VersionAlgorithmCoding", resource.VersionAlgorithmCoding, optionsValueSet, htmlAttrs)
}
...
func (resource *StructureDefinition) T_CopyrightLabel(htmlAttrs string) templ.Component {
	...
	if resource == nil {
		return StringInput("StructureDefinition.CopyrightLabel", nil, htmlAttrs)
	}
	return StringInput("StructureDefinition.CopyrightLabel", resource.CopyrightLabel, htmlAttrs)
}
