...
func (resource *MedicationKnowledge) T_IntendedJurisdiction(optionsValueSet []Coding) templ.Component {
...
func (resource *MedicationKnowledge) T_RegulatorySchedule(numRegulatory int, optionsValueSet []Coding) templ.Component {
...
func (resource *MedicationKnowledge) T_DefinitionalIntendedRoute(optionsValueSet []Coding) templ.Component {
