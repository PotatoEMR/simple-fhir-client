...
func (resource *CapabilityStatement) CapabilityStatementAcceptLanguage(optionsValueSet []Coding) templ.Component {

	if resource != nil {
		return CodeSelect("acceptLanguage", nil, optionsValueSet)
	}
	return CodeSelect("acceptLanguage", &resource.AcceptLanguage[0], optionsValueSet)
}
