...
// json -> struct, first reject if resourceType != GenomicStudy
func (r *GenomicStudy) UnmarshalJSON(data []byte) error {
	if err := json.Unmarshal(data, &checkType); err != nil {
		return err
	} else if checkType.ResourceType != "GenomicStudy" {
		return errors.New("resourceType not GenomicStudy")
	}
	return json.Unmarshal(data, (*OtherGenomicStudy)(r))
}
...
func (resource *GenomicStudy) T_Subject(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ReferenceInput(frs, "subject", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "subject", &resource.Subject, htmlAttrs)
}
func (resource *GenomicStudy) T_Encounter(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *GenomicStudy) T_BasedOn(frs []FhirResource, numBasedOn int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *GenomicStudy) T_Referrer(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ReferenceInput(frs, "referrer", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "referrer", resource.Referrer, htmlAttrs)
}
func (resource *GenomicStudy) T_Interpreter(frs []FhirResource, numInterpreter int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numInterpreter >= len(resource.Interpreter) {
		return ReferenceInput(frs, "interpreter["+strconv.Itoa(numInterpreter)+"]", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "interpreter["+strconv.Itoa(numInterpreter)+"]", &resource.Interpreter[numInterpreter], htmlAttrs)
}
...
func (resource *GenomicStudy) T_AnalysisFocus(frs []FhirResource, numAnalysis int, numFocus int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numFocus >= len(resource.Analysis[numAnalysis].Focus) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].focus["+strconv.Itoa(numFocus)+"]", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].focus["+strconv.Itoa(numFocus)+"]", &resource.Analysis[numAnalysis].Focus[numFocus], htmlAttrs)
}
func (resource *GenomicStudy) T_AnalysisSpecimen(frs []FhirResource, numAnalysis int, numSpecimen int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numSpecimen >= len(resource.Analysis[numAnalysis].Specimen) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].specimen["+strconv.Itoa(numSpecimen)+"]", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].specimen["+strconv.Itoa(numSpecimen)+"]", &resource.Analysis[numAnalysis].Specimen[numSpecimen], htmlAttrs)
}
...
func (resource *GenomicStudy) T_AnalysisProtocolPerformed(frs []FhirResource, numAnalysis int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].protocolPerformed", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].protocolPerformed", resource.Analysis[numAnalysis].ProtocolPerformed, htmlAttrs)
}
func (resource *GenomicStudy) T_AnalysisRegionsStudied(frs []FhirResource, numAnalysis int, numRegionsStudied int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numRegionsStudied >= len(resource.Analysis[numAnalysis].RegionsStudied) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].regionsStudied["+strconv.Itoa(numRegionsStudied)+"]", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].regionsStudied["+strconv.Itoa(numRegionsStudied)+"]", &resource.Analysis[numAnalysis].RegionsStudied[numRegionsStudied], htmlAttrs)
}
func (resource *GenomicStudy) T_AnalysisRegionsCalled(frs []FhirResource, numAnalysis int, numRegionsCalled int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numRegionsCalled >= len(resource.Analysis[numAnalysis].RegionsCalled) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].regionsCalled["+strconv.Itoa(numRegionsCalled)+"]", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].regionsCalled["+strconv.Itoa(numRegionsCalled)+"]", &resource.Analysis[numAnalysis].RegionsCalled[numRegionsCalled], htmlAttrs)
}
func (resource *GenomicStudy) T_AnalysisInputFile(frs []FhirResource, numAnalysis int, numInput int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numInput >= len(resource.Analysis[numAnalysis].Input) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].input["+strconv.Itoa(numInput)+"].file", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].input["+strconv.Itoa(numInput)+"].file", resource.Analysis[numAnalysis].Input[numInput].File, htmlAttrs)
}
...
func (resource *GenomicStudy) T_AnalysisInputGeneratedByReference(frs []FhirResource, numAnalysis int, numInput int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numInput >= len(resource.Analysis[numAnalysis].Input) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].input["+strconv.Itoa(numInput)+"].generatedByReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].input["+strconv.Itoa(numInput)+"].generatedByReference", resource.Analysis[numAnalysis].Input[numInput].GeneratedByReference, htmlAttrs)
}
func (resource *GenomicStudy) T_AnalysisOutputFile(frs []FhirResource, numAnalysis int, numOutput int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numOutput >= len(resource.Analysis[numAnalysis].Output) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].output["+strconv.Itoa(numOutput)+"].file", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].output["+strconv.Itoa(numOutput)+"].file", resource.Analysis[numAnalysis].Output[numOutput].File, htmlAttrs)
}
...
func (resource *GenomicStudy) T_AnalysisPerformerActor(frs []FhirResource, numAnalysis int, numPerformer int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numPerformer >= len(resource.Analysis[numAnalysis].Performer) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].performer["+strconv.Itoa(numPerformer)+"].actor", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].performer["+strconv.Itoa(numPerformer)+"].actor", resource.Analysis[numAnalysis].Performer[numPerformer].Actor, htmlAttrs)
}
...
func (resource *GenomicStudy) T_AnalysisDeviceDevice(frs []FhirResource, numAnalysis int, numDevice int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAnalysis >= len(resource.Analysis) || numDevice >= len(resource.Analysis[numAnalysis].Device) {
		return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].device["+strconv.Itoa(numDevice)+"].device", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "analysis["+strconv.Itoa(numAnalysis)+"].device["+strconv.Itoa(numDevice)+"].device", resource.Analysis[numAnalysis].Device[numDevice].Device, htmlAttrs)
}
