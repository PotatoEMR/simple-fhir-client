...
func (resource *Questionnaire) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("Questionnaire.CopyrightLabel", nil)
	}
	return StringInput("Questionnaire.CopyrightLabel", resource.CopyrightLabel)
}
...
func (resource *Questionnaire) T_ItemDisabledDisplay(numItem int) templ.Component {
	optionsValueSet := VSQuestionnaire_disabled_display

	if resource == nil || len(resource.Item) >= numItem {
		return CodeSelect("Questionnaire.Item["+strconv.Itoa(numItem)+"].DisabledDisplay", nil, optionsValueSet)
	}
	return CodeSelect("Questionnaire.Item["+strconv.Itoa(numItem)+"].DisabledDisplay", resource.Item[numItem].DisabledDisplay, optionsValueSet)
}
...
func (resource *Questionnaire) T_ItemAnswerConstraint(numItem int) templ.Component {
	optionsValueSet := VSQuestionnaire_answer_constraint

	if resource == nil || len(resource.Item) >= numItem {
		return CodeSelect("Questionnaire.Item["+strconv.Itoa(numItem)+"].AnswerConstraint", nil, optionsValueSet)
	}
	return CodeSelect("Questionnaire.Item["+strconv.Itoa(numItem)+"].AnswerConstraint", resource.Item[numItem].AnswerConstraint, optionsValueSet)
}
