...
func (resource *Library) T_VersionAlgorithmString(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("Library.VersionAlgorithmString", nil, htmlAttrs)
	}
	return StringInput("Library.VersionAlgorithmString", resource.VersionAlgorithmString, htmlAttrs)
}
func (resource *Library) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodingSelect("Library.VersionAlgorithmCoding", nil, optionsValueSet, htmlAttrs)
	}
	return CodingSelect("Library.VersionAlgorithmCoding", resource.VersionAlgorithmCoding, optionsValueSet, htmlAttrs)
}
...
func (resource *Library) T_CopyrightLabel(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("Library.CopyrightLabel", nil, htmlAttrs)
	}
	return StringInput("Library.CopyrightLabel", resource.CopyrightLabel, htmlAttrs)
}
