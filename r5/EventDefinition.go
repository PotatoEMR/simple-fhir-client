...
func (resource *EventDefinition) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("EventDefinition.CopyrightLabel", nil)
	}
	return StringInput("EventDefinition.CopyrightLabel", resource.CopyrightLabel)
}
