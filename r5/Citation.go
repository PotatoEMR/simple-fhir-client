...
func (resource *Citation) CitationCitedArtifactRelatesToClassifier(numRelatesTo int, optionsValueSet []Coding) templ.Component {
...
func (resource *Citation) CitationCitedArtifactPublicationFormCitedMedium(numPublicationForm int, optionsValueSet []Coding) templ.Component {
...
func (resource *Citation) CitationCitedArtifactWebLocationClassifier(numWebLocation int, optionsValueSet []Coding) templ.Component {
