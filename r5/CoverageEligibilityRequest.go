...
func (resource *CoverageEligibilityRequest) T_EventId(numEvent int) templ.Component {

	if resource == nil || len(resource.Event) >= numEvent {
		return StringInput("CoverageEligibilityRequest.Event["+strconv.Itoa(numEvent)+"].Id", nil)
	}
	return StringInput("CoverageEligibilityRequest.Event["+strconv.Itoa(numEvent)+"].Id", resource.Event[numEvent].Id)
}
func (resource *CoverageEligibilityRequest) T_EventType(numEvent int, optionsValueSet []Coding) templ.Component {

	if resource == nil || len(resource.Event) >= numEvent {
		return CodeableConceptSelect("CoverageEligibilityRequest.Event["+strconv.Itoa(numEvent)+"].Type", nil, optionsValueSet)
	}
	return CodeableConceptSelect("CoverageEligibilityRequest.Event["+strconv.Itoa(numEvent)+"].Type", &resource.Event[numEvent].Type, optionsValueSet)
}
