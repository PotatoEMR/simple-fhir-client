...
func (resource *DeviceMetric) T_Device(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *DeviceMetric) T_MeasurementFrequency(optionsValueSet []Coding, htmlAttrs QuantityAttrs) templ.Component {
	if resource == nil {
		return QuantityInput("measurementFrequency", nil, optionsValueSet, htmlAttrs)
	}
	return QuantityInput("measurementFrequency", resource.MeasurementFrequency, optionsValueSet, htmlAttrs)
}
