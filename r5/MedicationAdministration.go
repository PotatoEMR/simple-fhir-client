...
func (resource *MedicationAdministration) T_BasedOn(numBasedOn int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *MedicationAdministration) T_Encounter(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
