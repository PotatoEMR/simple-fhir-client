...
func (resource *ActivityDefinition) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("ActivityDefinition.CopyrightLabel", nil)
	}
	return StringInput("ActivityDefinition.CopyrightLabel", resource.CopyrightLabel)
}
...
func (resource *ActivityDefinition) T_SpecimenRequirement(numSpecimenRequirement int) templ.Component {

	if resource == nil || len(resource.SpecimenRequirement) >= numSpecimenRequirement {
		return StringInput("ActivityDefinition.SpecimenRequirement["+strconv.Itoa(numSpecimenRequirement)+"]", nil)
	}
	return StringInput("ActivityDefinition.SpecimenRequirement["+strconv.Itoa(numSpecimenRequirement)+"]", &resource.SpecimenRequirement[numSpecimenRequirement])
}
func (resource *ActivityDefinition) T_ObservationRequirement(numObservationRequirement int) templ.Component {

	if resource == nil || len(resource.ObservationRequirement) >= numObservationRequirement {
		return StringInput("ActivityDefinition.ObservationRequirement["+strconv.Itoa(numObservationRequirement)+"]", nil)
	}
	return StringInput("ActivityDefinition.ObservationRequirement["+strconv.Itoa(numObservationRequirement)+"]", &resource.ObservationRequirement[numObservationRequirement])
}
func (resource *ActivityDefinition) T_ObservationResultRequirement(numObservationResultRequirement int) templ.Component {

	if resource == nil || len(resource.ObservationResultRequirement) >= numObservationResultRequirement {
		return StringInput("ActivityDefinition.ObservationResultRequirement["+strconv.Itoa(numObservationResultRequirement)+"]", nil)
	}
	return StringInput("ActivityDefinition.ObservationResultRequirement["+strconv.Itoa(numObservationResultRequirement)+"]", &resource.ObservationResultRequirement[numObservationResultRequirement])
}
...
func (resource *ActivityDefinition) T_ParticipantTypeCanonical(numParticipant int) templ.Component {

	if resource == nil || len(resource.Participant) >= numParticipant {
		return StringInput("ActivityDefinition.Participant["+strconv.Itoa(numParticipant)+"].TypeCanonical", nil)
	}
	return StringInput("ActivityDefinition.Participant["+strconv.Itoa(numParticipant)+"].TypeCanonical", resource.Participant[numParticipant].TypeCanonical)
}
...
func (resource *ActivityDefinition) T_ParticipantFunction(numParticipant int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.Participant) >= numParticipant {
		return CodeableConceptSelect("ActivityDefinition.Participant["+strconv.Itoa(numParticipant)+"].Function", nil, optionsValueSet)
	}
	return CodeableConceptSelect("ActivityDefinition.Participant["+strconv.Itoa(numParticipant)+"].Function", resource.Participant[numParticipant].Function, optionsValueSet)
}
