...
func (resource *ActivityDefinition) T_VersionAlgorithmString(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("ActivityDefinition.VersionAlgorithmString", nil, htmlAttrs)
	}
	return StringInput("ActivityDefinition.VersionAlgorithmString", resource.VersionAlgorithmString, htmlAttrs)
}
func (resource *ActivityDefinition) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodingSelect("ActivityDefinition.VersionAlgorithmCoding", nil, optionsValueSet, htmlAttrs)
	}
	return CodingSelect("ActivityDefinition.VersionAlgorithmCoding", resource.VersionAlgorithmCoding, optionsValueSet, htmlAttrs)
}
...
func (resource *ActivityDefinition) T_CopyrightLabel(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("ActivityDefinition.CopyrightLabel", nil, htmlAttrs)
	}
	return StringInput("ActivityDefinition.CopyrightLabel", resource.CopyrightLabel, htmlAttrs)
}
...
func (resource *ActivityDefinition) T_AsNeededBoolean(htmlAttrs string) templ.Component {

	if resource == nil {
		return BoolInput("ActivityDefinition.AsNeededBoolean", nil, htmlAttrs)
	}
	return BoolInput("ActivityDefinition.AsNeededBoolean", resource.AsNeededBoolean, htmlAttrs)
}
func (resource *ActivityDefinition) T_AsNeededCodeableConcept(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodeableConceptSelect("ActivityDefinition.AsNeededCodeableConcept", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("ActivityDefinition.AsNeededCodeableConcept", resource.AsNeededCodeableConcept, optionsValueSet, htmlAttrs)
}
...
func (resource *ActivityDefinition) T_SpecimenRequirement(numSpecimenRequirement int, htmlAttrs string) templ.Component {

	if resource == nil || numSpecimenRequirement >= len(resource.SpecimenRequirement) {
		return StringInput("ActivityDefinition.SpecimenRequirement."+strconv.Itoa(numSpecimenRequirement)+".", nil, htmlAttrs)
	}
	return StringInput("ActivityDefinition.SpecimenRequirement."+strconv.Itoa(numSpecimenRequirement)+".", &resource.SpecimenRequirement[numSpecimenRequirement], htmlAttrs)
}
func (resource *ActivityDefinition) T_ObservationRequirement(numObservationRequirement int, htmlAttrs string) templ.Component {

	if resource == nil || numObservationRequirement >= len(resource.ObservationRequirement) {
		return StringInput("ActivityDefinition.ObservationRequirement."+strconv.Itoa(numObservationRequirement)+".", nil, htmlAttrs)
	}
	return StringInput("ActivityDefinition.ObservationRequirement."+strconv.Itoa(numObservationRequirement)+".", &resource.ObservationRequirement[numObservationRequirement], htmlAttrs)
}
func (resource *ActivityDefinition) T_ObservationResultRequirement(numObservationResultRequirement int, htmlAttrs string) templ.Component {

	if resource == nil || numObservationResultRequirement >= len(resource.ObservationResultRequirement) {
		return StringInput("ActivityDefinition.ObservationResultRequirement."+strconv.Itoa(numObservationResultRequirement)+".", nil, htmlAttrs)
	}
	return StringInput("ActivityDefinition.ObservationResultRequirement."+strconv.Itoa(numObservationResultRequirement)+".", &resource.ObservationResultRequirement[numObservationResultRequirement], htmlAttrs)
}
...
func (resource *ActivityDefinition) T_ParticipantTypeCanonical(numParticipant int, htmlAttrs string) templ.Component {

	if resource == nil || numParticipant >= len(resource.Participant) {
		return StringInput("ActivityDefinition.Participant."+strconv.Itoa(numParticipant)+"..TypeCanonical", nil, htmlAttrs)
	}
	return StringInput("ActivityDefinition.Participant."+strconv.Itoa(numParticipant)+"..TypeCanonical", resource.Participant[numParticipant].TypeCanonical, htmlAttrs)
}
...
func (resource *ActivityDefinition) T_ParticipantFunction(numParticipant int, optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil || numParticipant >= len(resource.Participant) {
		return CodeableConceptSelect("ActivityDefinition.Participant."+strconv.Itoa(numParticipant)+"..Function", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("ActivityDefinition.Participant."+strconv.Itoa(numParticipant)+"..Function", resource.Participant[numParticipant].Function, optionsValueSet, htmlAttrs)
}
