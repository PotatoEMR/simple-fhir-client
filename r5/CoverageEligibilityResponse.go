...
func (resource *CoverageEligibilityResponse) T_EventType(numEvent int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *CoverageEligibilityResponse) T_ErrorExpression(numError int, numExpression int, htmlAttrs templ.Attributes) templ.Component {
