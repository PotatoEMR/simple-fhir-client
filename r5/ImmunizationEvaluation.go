...
func (resource *ImmunizationEvaluation) T_DoseNumber() templ.Component {

	if resource == nil {
		return StringInput("ImmunizationEvaluation.DoseNumber", nil)
	}
	return StringInput("ImmunizationEvaluation.DoseNumber", resource.DoseNumber)
}
func (resource *ImmunizationEvaluation) T_SeriesDoses() templ.Component {

	if resource == nil {
		return StringInput("ImmunizationEvaluation.SeriesDoses", nil)
	}
	return StringInput("ImmunizationEvaluation.SeriesDoses", resource.SeriesDoses)
}
