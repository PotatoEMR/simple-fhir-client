...
func (resource *ClaimResponse) T_Encounter(frs []FhirResource, numEncounter int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ClaimResponse) T_ItemAdjudicationQuantity(numItem int, numAdjudication int, optionsValueSet []Coding, htmlAttrs QuantityAttrs) templ.Component {
	if resource == nil || numItem >= len(resource.Item) || numAdjudication >= len(resource.Item[numItem].Adjudication) {
...
func (resource *ClaimResponse) T_AddItemRequest(frs []FhirResource, numAddItem int, numRequest int, htmlAttrs templ.Attributes) templ.Component {
