...
func (resource *Group) T_Membership() templ.Component {
	...
	if resource == nil {
		return CodeSelect("Group.Membership", nil, optionsValueSet)
	}
	return CodeSelect("Group.Membership", &resource.Membership, optionsValueSet)
}
...
func (resource *Group) T_Description() templ.Component {

	if resource == nil {
		return StringInput("Group.Description", nil)
	}
	return StringInput("Group.Description", resource.Description)
}
