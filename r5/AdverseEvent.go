...
func (resource *AdverseEvent) T_OccurrencePeriod(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return PeriodInput("occurrencePeriod", nil, htmlAttrs)
	}
	return PeriodInput("occurrencePeriod", resource.OccurrencePeriod, htmlAttrs)
}
func (resource *AdverseEvent) T_OccurrenceTiming(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *AdverseEvent) T_ResultingEffect(frs []FhirResource, numResultingEffect int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numResultingEffect >= len(resource.ResultingEffect) {
		return ReferenceInput(frs, "resultingEffect["+strconv.Itoa(numResultingEffect)+"]", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "resultingEffect["+strconv.Itoa(numResultingEffect)+"]", &resource.ResultingEffect[numResultingEffect], htmlAttrs)
}
...
func (resource *AdverseEvent) T_ParticipantActor(frs []FhirResource, numParticipant int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numParticipant >= len(resource.Participant) {
...
func (resource *AdverseEvent) T_SuspectEntityInstanceReference(frs []FhirResource, numSuspectEntity int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numSuspectEntity >= len(resource.SuspectEntity) {
		return ReferenceInput(frs, "suspectEntity["+strconv.Itoa(numSuspectEntity)+"].instanceReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "suspectEntity["+strconv.Itoa(numSuspectEntity)+"].instanceReference", &resource.SuspectEntity[numSuspectEntity].InstanceReference, htmlAttrs)
}
...
func (resource *AdverseEvent) T_SuspectEntityCausalityAuthor(frs []FhirResource, numSuspectEntity int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numSuspectEntity >= len(resource.SuspectEntity) {
		return ReferenceInput(frs, "suspectEntity["+strconv.Itoa(numSuspectEntity)+"].causality.author", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "suspectEntity["+strconv.Itoa(numSuspectEntity)+"].causality.author", resource.SuspectEntity[numSuspectEntity].Causality.Author, htmlAttrs)
}
func (resource *AdverseEvent) T_ContributingFactorItemReference(frs []FhirResource, numContributingFactor int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numContributingFactor >= len(resource.ContributingFactor) {
		return ReferenceInput(frs, "contributingFactor["+strconv.Itoa(numContributingFactor)+"].itemReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "contributingFactor["+strconv.Itoa(numContributingFactor)+"].itemReference", &resource.ContributingFactor[numContributingFactor].ItemReference, htmlAttrs)
}
...
func (resource *AdverseEvent) T_PreventiveActionItemReference(frs []FhirResource, numPreventiveAction int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numPreventiveAction >= len(resource.PreventiveAction) {
		return ReferenceInput(frs, "preventiveAction["+strconv.Itoa(numPreventiveAction)+"].itemReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "preventiveAction["+strconv.Itoa(numPreventiveAction)+"].itemReference", &resource.PreventiveAction[numPreventiveAction].ItemReference, htmlAttrs)
}
...
func (resource *AdverseEvent) T_MitigatingActionItemReference(frs []FhirResource, numMitigatingAction int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numMitigatingAction >= len(resource.MitigatingAction) {
		return ReferenceInput(frs, "mitigatingAction["+strconv.Itoa(numMitigatingAction)+"].itemReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "mitigatingAction["+strconv.Itoa(numMitigatingAction)+"].itemReference", &resource.MitigatingAction[numMitigatingAction].ItemReference, htmlAttrs)
}
...
func (resource *AdverseEvent) T_SupportingInfoItemReference(frs []FhirResource, numSupportingInfo int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numSupportingInfo >= len(resource.SupportingInfo) {
		return ReferenceInput(frs, "supportingInfo["+strconv.Itoa(numSupportingInfo)+"].itemReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "supportingInfo["+strconv.Itoa(numSupportingInfo)+"].itemReference", &resource.SupportingInfo[numSupportingInfo].ItemReference, htmlAttrs)
}
