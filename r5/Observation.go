...
// json -> struct, first reject if resourceType != Observation
func (r *Observation) UnmarshalJSON(data []byte) error {
	if err := json.Unmarshal(data, &checkType); err != nil {
		return err
	} else if checkType.ResourceType != "Observation" {
		return errors.New("resourceType not Observation")
	}
	return json.Unmarshal(data, (*OtherObservation)(r))
}
...
func (resource *Observation) T_InstantiatesReference(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ReferenceInput(frs, "instantiatesReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "instantiatesReference", resource.InstantiatesReference, htmlAttrs)
}
...
func (resource *Observation) T_ValueReference(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ReferenceInput(frs, "valueReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "valueReference", resource.ValueReference, htmlAttrs)
}
...
func (resource *Observation) T_BodyStructure(frs []FhirResource, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Observation) T_TriggeredByObservation(frs []FhirResource, numTriggeredBy int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numTriggeredBy >= len(resource.TriggeredBy) {
		return ReferenceInput(frs, "triggeredBy["+strconv.Itoa(numTriggeredBy)+"].observation", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "triggeredBy["+strconv.Itoa(numTriggeredBy)+"].observation", &resource.TriggeredBy[numTriggeredBy].Observation, htmlAttrs)
}
...
func (resource *Observation) T_ComponentValueReference(frs []FhirResource, numComponent int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numComponent >= len(resource.Component) {
		return ReferenceInput(frs, "component["+strconv.Itoa(numComponent)+"].valueReference", nil, htmlAttrs)
	}
	return ReferenceInput(frs, "component["+strconv.Itoa(numComponent)+"].valueReference", resource.Component[numComponent].ValueReference, htmlAttrs)
}
