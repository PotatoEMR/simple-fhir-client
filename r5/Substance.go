...
// json -> struct, first reject if resourceType != Substance
func (r *Substance) UnmarshalJSON(data []byte) error {
	if err := json.Unmarshal(data, &checkType); err != nil {
		return err
	} else if checkType.ResourceType != "Substance" {
		return errors.New("resourceType not Substance")
	}
	return json.Unmarshal(data, (*OtherSubstance)(r))
}
...
func (resource *Substance) T_Code(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Substance) T_Expiry(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return FhirDateTimeInput("expiry", nil, htmlAttrs)
	}
	return FhirDateTimeInput("expiry", resource.Expiry, htmlAttrs)
}
func (resource *Substance) T_Quantity(optionsValueSet []Coding, htmlAttrs QuantityAttrs) templ.Component {
	if resource == nil {
