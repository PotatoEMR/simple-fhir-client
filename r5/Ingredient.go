...
func (resource *Ingredient) T_SubstanceStrengthPresentationCodeableConcept(numStrength int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numStrength >= len(resource.Substance.Strength) {
		return CodeableConceptSelect("SubstanceStrength["+strconv.Itoa(numStrength)+"].PresentationCodeableConcept", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("SubstanceStrength["+strconv.Itoa(numStrength)+"].PresentationCodeableConcept", resource.Substance.Strength[numStrength].PresentationCodeableConcept, optionsValueSet, htmlAttrs)
}
...
func (resource *Ingredient) T_SubstanceStrengthConcentrationCodeableConcept(numStrength int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numStrength >= len(resource.Substance.Strength) {
		return CodeableConceptSelect("SubstanceStrength["+strconv.Itoa(numStrength)+"].ConcentrationCodeableConcept", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("SubstanceStrength["+strconv.Itoa(numStrength)+"].ConcentrationCodeableConcept", resource.Substance.Strength[numStrength].ConcentrationCodeableConcept, optionsValueSet, htmlAttrs)
}
...
func (resource *Ingredient) T_SubstanceStrengthBasis(numStrength int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numStrength >= len(resource.Substance.Strength) {
		return CodeableConceptSelect("SubstanceStrength["+strconv.Itoa(numStrength)+"].Basis", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("SubstanceStrength["+strconv.Itoa(numStrength)+"].Basis", resource.Substance.Strength[numStrength].Basis, optionsValueSet, htmlAttrs)
}
