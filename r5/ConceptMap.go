...
func (resource *ConceptMap) T_VersionAlgorithmString(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *ConceptMap) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *ConceptMap) T_CopyrightLabel(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *ConceptMap) T_SourceScopeCanonical(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *ConceptMap) T_TargetScopeUri(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return StringInput("targetScopeUri", nil, htmlAttrs)
	}
	return StringInput("targetScopeUri", resource.TargetScopeUri, htmlAttrs)
}
func (resource *ConceptMap) T_TargetScopeCanonical(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *ConceptMap) T_PropertyCode(numProperty int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_PropertyUri(numProperty int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numProperty >= len(resource.Property) {
...
func (resource *ConceptMap) T_PropertyDescription(numProperty int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numProperty >= len(resource.Property) {
...
func (resource *ConceptMap) T_PropertyType(numProperty int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_PropertySystem(numProperty int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numProperty >= len(resource.Property) {
...
func (resource *ConceptMap) T_AdditionalAttributeCode(numAdditionalAttribute int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_AdditionalAttributeUri(numAdditionalAttribute int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAdditionalAttribute >= len(resource.AdditionalAttribute) {
...
func (resource *ConceptMap) T_AdditionalAttributeDescription(numAdditionalAttribute int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAdditionalAttribute >= len(resource.AdditionalAttribute) {
...
func (resource *ConceptMap) T_AdditionalAttributeType(numAdditionalAttribute int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_GroupElementValueSet(numGroup int, numElement int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) {
...
func (resource *ConceptMap) T_GroupElementNoMap(numGroup int, numElement int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) {
...
func (resource *ConceptMap) T_GroupElementTargetValueSet(numGroup int, numElement int, numTarget int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) {
...
func (resource *ConceptMap) T_GroupElementTargetRelationship(numGroup int, numElement int, numTarget int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_GroupElementTargetPropertyCode(numGroup int, numElement int, numTarget int, numProperty int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_GroupElementTargetPropertyValueCoding(numGroup int, numElement int, numTarget int, numProperty int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numProperty >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].Property) {
...
func (resource *ConceptMap) T_GroupElementTargetPropertyValueString(numGroup int, numElement int, numTarget int, numProperty int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numProperty >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].Property) {
...
func (resource *ConceptMap) T_GroupElementTargetPropertyValueInteger(numGroup int, numElement int, numTarget int, numProperty int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numProperty >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].Property) {
...
func (resource *ConceptMap) T_GroupElementTargetPropertyValueBoolean(numGroup int, numElement int, numTarget int, numProperty int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numProperty >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].Property) {
...
func (resource *ConceptMap) T_GroupElementTargetPropertyValueCode(numGroup int, numElement int, numTarget int, numProperty int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numProperty >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].Property) {
...
func (resource *ConceptMap) T_GroupElementTargetDependsOnAttribute(numGroup int, numElement int, numTarget int, numDependsOn int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *ConceptMap) T_GroupElementTargetDependsOnValueCode(numGroup int, numElement int, numTarget int, numDependsOn int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numDependsOn >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].DependsOn) {
...
func (resource *ConceptMap) T_GroupElementTargetDependsOnValueCoding(numGroup int, numElement int, numTarget int, numDependsOn int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numDependsOn >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].DependsOn) {
...
func (resource *ConceptMap) T_GroupElementTargetDependsOnValueString(numGroup int, numElement int, numTarget int, numDependsOn int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numDependsOn >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].DependsOn) {
...
func (resource *ConceptMap) T_GroupElementTargetDependsOnValueBoolean(numGroup int, numElement int, numTarget int, numDependsOn int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numElement >= len(resource.Group[numGroup].Element) || numTarget >= len(resource.Group[numGroup].Element[numElement].Target) || numDependsOn >= len(resource.Group[numGroup].Element[numElement].Target[numTarget].DependsOn) {
...
func (resource *ConceptMap) T_GroupUnmappedValueSet(numGroup int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
...
func (resource *ConceptMap) T_GroupUnmappedRelationship(numGroup int, htmlAttrs templ.Attributes) templ.Component {
	optionsValueSet := VSConcept_map_relationship
...
func (resource *ConceptMap) T_GroupUnmappedOtherMap(numGroup int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
