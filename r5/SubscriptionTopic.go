...
func (resource *SubscriptionTopic) T_VersionAlgorithmString(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *SubscriptionTopic) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *SubscriptionTopic) T_Name(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *SubscriptionTopic) T_CopyrightLabel(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *SubscriptionTopic) T_CanFilterByComparator(numCanFilterBy int, numComparator int, htmlAttrs templ.Attributes) templ.Component {
	...
	if resource == nil || numCanFilterBy >= len(resource.CanFilterBy) || numComparator >= len(resource.CanFilterBy[numCanFilterBy].Comparator) {
		return CodeSelect("canFilterBy["+strconv.Itoa(numCanFilterBy)+"].comparator["+strconv.Itoa(numComparator)+"]", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("canFilterBy["+strconv.Itoa(numCanFilterBy)+"].comparator["+strconv.Itoa(numComparator)+"]", &resource.CanFilterBy[numCanFilterBy].Comparator[numComparator], optionsValueSet, htmlAttrs)
}
