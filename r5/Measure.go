...
func (resource *Measure) T_VersionAlgorithmString(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Measure) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Measure) T_CopyrightLabel(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Measure) T_ScoringUnit(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Measure) T_ImprovementNotation(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Measure) T_TermCode(numTerm int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Measure) T_TermDefinition(numTerm int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numTerm >= len(resource.Term) {
...
func (resource *Measure) T_GroupLinkId(numGroup int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Measure) T_GroupType(numGroup int, numType int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Measure) T_GroupSubjectCodeableConcept(numGroup int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
...
func (resource *Measure) T_GroupScoring(numGroup int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
...
func (resource *Measure) T_GroupScoringUnit(numGroup int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
...
func (resource *Measure) T_GroupRateAggregation(numGroup int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
...
func (resource *Measure) T_GroupImprovementNotation(numGroup int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) {
...
func (resource *Measure) T_GroupLibrary(numGroup int, numLibrary int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Measure) T_GroupPopulationLinkId(numGroup int, numPopulation int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Measure) T_GroupPopulationAggregateMethod(numGroup int, numPopulation int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numGroup >= len(resource.Group) || numPopulation >= len(resource.Group[numGroup].Population) {
...
func (resource *Measure) T_GroupStratifierLinkId(numGroup int, numStratifier int, htmlAttrs templ.Attributes) templ.Component {
