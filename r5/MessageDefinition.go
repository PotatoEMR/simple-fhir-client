...
func (resource *MessageDefinition) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("MessageDefinition.CopyrightLabel", nil)
	}
	return StringInput("MessageDefinition.CopyrightLabel", resource.CopyrightLabel)
}
...
func (resource *MessageDefinition) T_Graph() templ.Component {

	if resource == nil {
		return StringInput("MessageDefinition.Graph", nil)
	}
	return StringInput("MessageDefinition.Graph", resource.Graph)
}
