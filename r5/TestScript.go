...
func (resource *TestScript) T_VersionAlgorithmString(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *TestScript) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *TestScript) T_CopyrightLabel(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *TestScript) T_Profile(numProfile int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numProfile >= len(resource.Profile) {
		return StringInput("profile["+strconv.Itoa(numProfile)+"]", nil, htmlAttrs)
	}
	return StringInput("profile["+strconv.Itoa(numProfile)+"]", &resource.Profile[numProfile], htmlAttrs)
}
...
func (resource *TestScript) T_OriginUrl(numOrigin int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numOrigin >= len(resource.Origin) {
		return StringInput("origin["+strconv.Itoa(numOrigin)+"].url", nil, htmlAttrs)
	}
	return StringInput("origin["+strconv.Itoa(numOrigin)+"].url", resource.Origin[numOrigin].Url, htmlAttrs)
}
...
func (resource *TestScript) T_DestinationUrl(numDestination int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numDestination >= len(resource.Destination) {
		return StringInput("destination["+strconv.Itoa(numDestination)+"].url", nil, htmlAttrs)
	}
	return StringInput("destination["+strconv.Itoa(numDestination)+"].url", resource.Destination[numDestination].Url, htmlAttrs)
}
...
func (resource *TestScript) T_ScopeArtifact(numScope int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numScope >= len(resource.Scope) {
		return StringInput("scope["+strconv.Itoa(numScope)+"].artifact", nil, htmlAttrs)
	}
	return StringInput("scope["+strconv.Itoa(numScope)+"].artifact", &resource.Scope[numScope].Artifact, htmlAttrs)
}
func (resource *TestScript) T_ScopeConformance(numScope int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numScope >= len(resource.Scope) {
		return CodeableConceptSelect("scope["+strconv.Itoa(numScope)+"].conformance", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("scope["+strconv.Itoa(numScope)+"].conformance", resource.Scope[numScope].Conformance, optionsValueSet, htmlAttrs)
}
func (resource *TestScript) T_ScopePhase(numScope int, optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numScope >= len(resource.Scope) {
		return CodeableConceptSelect("scope["+strconv.Itoa(numScope)+"].phase", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("scope["+strconv.Itoa(numScope)+"].phase", resource.Scope[numScope].Phase, optionsValueSet, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionOperationResource(numAction int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return StringInput("setup.action["+strconv.Itoa(numAction)+"].operation.resource", nil, htmlAttrs)
	}
	return StringInput("setup.action["+strconv.Itoa(numAction)+"].operation.resource", resource.Setup.Action[numAction].Operation.Resource, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertDefaultManualCompletion(numAction int, htmlAttrs templ.Attributes) templ.Component {
	optionsValueSet := VSAssert_manual_completion_codes

	if resource == nil || numAction >= len(resource.Setup.Action) {
		return CodeSelect("setup.action["+strconv.Itoa(numAction)+"].assert.defaultManualCompletion", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("setup.action["+strconv.Itoa(numAction)+"].assert.defaultManualCompletion", resource.Setup.Action[numAction].Assert.DefaultManualCompletion, optionsValueSet, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertResource(numAction int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return StringInput("setup.action["+strconv.Itoa(numAction)+"].assert.resource", nil, htmlAttrs)
	}
	return StringInput("setup.action["+strconv.Itoa(numAction)+"].assert.resource", resource.Setup.Action[numAction].Assert.Resource, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertStopTestOnFail(numAction int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return BoolInput("setup.action["+strconv.Itoa(numAction)+"].assert.stopTestOnFail", nil, htmlAttrs)
	}
	return BoolInput("setup.action["+strconv.Itoa(numAction)+"].assert.stopTestOnFail", &resource.Setup.Action[numAction].Assert.StopTestOnFail, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertRequirementLinkUri(numAction int, numRequirement int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) || numRequirement >= len(resource.Setup.Action[numAction].Assert.Requirement) {
		return StringInput("setup.action["+strconv.Itoa(numAction)+"].assert.requirement["+strconv.Itoa(numRequirement)+"].linkUri", nil, htmlAttrs)
	}
	return StringInput("setup.action["+strconv.Itoa(numAction)+"].assert.requirement["+strconv.Itoa(numRequirement)+"].linkUri", resource.Setup.Action[numAction].Assert.Requirement[numRequirement].LinkUri, htmlAttrs)
}
func (resource *TestScript) T_SetupActionAssertRequirementLinkCanonical(numAction int, numRequirement int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) || numRequirement >= len(resource.Setup.Action[numAction].Assert.Requirement) {
		return StringInput("setup.action["+strconv.Itoa(numAction)+"].assert.requirement["+strconv.Itoa(numRequirement)+"].linkCanonical", nil, htmlAttrs)
	}
	return StringInput("setup.action["+strconv.Itoa(numAction)+"].assert.requirement["+strconv.Itoa(numRequirement)+"].linkCanonical", resource.Setup.Action[numAction].Assert.Requirement[numRequirement].LinkCanonical, htmlAttrs)
}
