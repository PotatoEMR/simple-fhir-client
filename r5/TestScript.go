...
func (resource *TestScript) T_VersionAlgorithmString(htmlAttrs string) templ.Component {
	if resource == nil {
		return StringInput("TestScript.VersionAlgorithmString", nil, htmlAttrs)
	}
	return StringInput("TestScript.VersionAlgorithmString", resource.VersionAlgorithmString, htmlAttrs)
}
func (resource *TestScript) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil {
		return CodingSelect("TestScript.VersionAlgorithmCoding", nil, optionsValueSet, htmlAttrs)
	}
	return CodingSelect("TestScript.VersionAlgorithmCoding", resource.VersionAlgorithmCoding, optionsValueSet, htmlAttrs)
}
...
func (resource *TestScript) T_CopyrightLabel(htmlAttrs string) templ.Component {
	if resource == nil {
		return StringInput("TestScript.CopyrightLabel", nil, htmlAttrs)
	}
	return StringInput("TestScript.CopyrightLabel", resource.CopyrightLabel, htmlAttrs)
}
func (resource *TestScript) T_Profile(numProfile int, htmlAttrs string) templ.Component {
	if resource == nil || numProfile >= len(resource.Profile) {
		return StringInput("TestScript.Profile["+strconv.Itoa(numProfile)+"]", nil, htmlAttrs)
	}
	return StringInput("TestScript.Profile["+strconv.Itoa(numProfile)+"]", &resource.Profile[numProfile], htmlAttrs)
}
...
func (resource *TestScript) T_OriginUrl(numOrigin int, htmlAttrs string) templ.Component {
	if resource == nil || numOrigin >= len(resource.Origin) {
		return StringInput("TestScript.Origin["+strconv.Itoa(numOrigin)+"].Url", nil, htmlAttrs)
	}
	return StringInput("TestScript.Origin["+strconv.Itoa(numOrigin)+"].Url", resource.Origin[numOrigin].Url, htmlAttrs)
}
...
func (resource *TestScript) T_DestinationUrl(numDestination int, htmlAttrs string) templ.Component {
	if resource == nil || numDestination >= len(resource.Destination) {
		return StringInput("TestScript.Destination["+strconv.Itoa(numDestination)+"].Url", nil, htmlAttrs)
	}
	return StringInput("TestScript.Destination["+strconv.Itoa(numDestination)+"].Url", resource.Destination[numDestination].Url, htmlAttrs)
}
...
func (resource *TestScript) T_ScopeArtifact(numScope int, htmlAttrs string) templ.Component {
	if resource == nil || numScope >= len(resource.Scope) {
		return StringInput("TestScript.Scope["+strconv.Itoa(numScope)+"].Artifact", nil, htmlAttrs)
	}
	return StringInput("TestScript.Scope["+strconv.Itoa(numScope)+"].Artifact", &resource.Scope[numScope].Artifact, htmlAttrs)
}
func (resource *TestScript) T_ScopeConformance(numScope int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numScope >= len(resource.Scope) {
		return CodeableConceptSelect("TestScript.Scope["+strconv.Itoa(numScope)+"].Conformance", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("TestScript.Scope["+strconv.Itoa(numScope)+"].Conformance", resource.Scope[numScope].Conformance, optionsValueSet, htmlAttrs)
}
func (resource *TestScript) T_ScopePhase(numScope int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
	if resource == nil || numScope >= len(resource.Scope) {
		return CodeableConceptSelect("TestScript.Scope["+strconv.Itoa(numScope)+"].Phase", nil, optionsValueSet, htmlAttrs)
	}
	return CodeableConceptSelect("TestScript.Scope["+strconv.Itoa(numScope)+"].Phase", resource.Scope[numScope].Phase, optionsValueSet, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionOperationResource(numAction int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Operation.Resource", nil, htmlAttrs)
	}
	return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Operation.Resource", resource.Setup.Action[numAction].Operation.Resource, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertDefaultManualCompletion(numAction int, htmlAttrs string) templ.Component {
	optionsValueSet := VSAssert_manual_completion_codes

	if resource == nil || numAction >= len(resource.Setup.Action) {
		return CodeSelect("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.DefaultManualCompletion", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.DefaultManualCompletion", resource.Setup.Action[numAction].Assert.DefaultManualCompletion, optionsValueSet, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertResource(numAction int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.Resource", nil, htmlAttrs)
	}
	return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.Resource", resource.Setup.Action[numAction].Assert.Resource, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertStopTestOnFail(numAction int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return BoolInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.StopTestOnFail", nil, htmlAttrs)
	}
	return BoolInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.StopTestOnFail", &resource.Setup.Action[numAction].Assert.StopTestOnFail, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertRequirementLinkUri(numAction int, numRequirement int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) || numRequirement >= len(resource.Setup.Action[numAction].Assert.Requirement) {
		return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.Requirement["+strconv.Itoa(numRequirement)+"].LinkUri", nil, htmlAttrs)
	}
	return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.Requirement["+strconv.Itoa(numRequirement)+"].LinkUri", resource.Setup.Action[numAction].Assert.Requirement[numRequirement].LinkUri, htmlAttrs)
}
func (resource *TestScript) T_SetupActionAssertRequirementLinkCanonical(numAction int, numRequirement int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) || numRequirement >= len(resource.Setup.Action[numAction].Assert.Requirement) {
		return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.Requirement["+strconv.Itoa(numRequirement)+"].LinkCanonical", nil, htmlAttrs)
	}
	return StringInput("TestScript.Setup.Action["+strconv.Itoa(numAction)+"].Assert.Requirement["+strconv.Itoa(numRequirement)+"].LinkCanonical", resource.Setup.Action[numAction].Assert.Requirement[numRequirement].LinkCanonical, htmlAttrs)
}
