...
func (resource *TestScript) T_SetupActionOperationResource(numAction int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return StringInput("SetupAction["+strconv.Itoa(numAction)+"].Operation.Resource", nil, htmlAttrs)
	}
	return StringInput("SetupAction["+strconv.Itoa(numAction)+"].Operation.Resource", resource.Setup.Action[numAction].Operation.Resource, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertDefaultManualCompletion(numAction int, htmlAttrs string) templ.Component {
	...
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return CodeSelect("SetupAction["+strconv.Itoa(numAction)+"].Assert.DefaultManualCompletion", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("SetupAction["+strconv.Itoa(numAction)+"].Assert.DefaultManualCompletion", resource.Setup.Action[numAction].Assert.DefaultManualCompletion, optionsValueSet, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertResource(numAction int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return StringInput("SetupAction["+strconv.Itoa(numAction)+"].Assert.Resource", nil, htmlAttrs)
	}
	return StringInput("SetupAction["+strconv.Itoa(numAction)+"].Assert.Resource", resource.Setup.Action[numAction].Assert.Resource, htmlAttrs)
}
...
func (resource *TestScript) T_SetupActionAssertStopTestOnFail(numAction int, htmlAttrs string) templ.Component {
	if resource == nil || numAction >= len(resource.Setup.Action) {
		return BoolInput("SetupAction["+strconv.Itoa(numAction)+"].Assert.StopTestOnFail", nil, htmlAttrs)
	}
	return BoolInput("SetupAction["+strconv.Itoa(numAction)+"].Assert.StopTestOnFail", &resource.Setup.Action[numAction].Assert.StopTestOnFail, htmlAttrs)
}
