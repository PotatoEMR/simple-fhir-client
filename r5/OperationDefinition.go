...
func (resource *OperationDefinition) T_VersionAlgorithmString(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("OperationDefinition.VersionAlgorithmString", nil, htmlAttrs)
	}
	return StringInput("OperationDefinition.VersionAlgorithmString", resource.VersionAlgorithmString, htmlAttrs)
}
func (resource *OperationDefinition) T_VersionAlgorithmCoding(optionsValueSet []Coding, htmlAttrs string) templ.Component {

	if resource == nil {
		return CodingSelect("OperationDefinition.VersionAlgorithmCoding", nil, optionsValueSet, htmlAttrs)
	}
	return CodingSelect("OperationDefinition.VersionAlgorithmCoding", resource.VersionAlgorithmCoding, optionsValueSet, htmlAttrs)
}
...
func (resource *OperationDefinition) T_Copyright(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("OperationDefinition.Copyright", nil, htmlAttrs)
	}
	return StringInput("OperationDefinition.Copyright", resource.Copyright, htmlAttrs)
}
func (resource *OperationDefinition) T_CopyrightLabel(htmlAttrs string) templ.Component {

	if resource == nil {
		return StringInput("OperationDefinition.CopyrightLabel", nil, htmlAttrs)
	}
	return StringInput("OperationDefinition.CopyrightLabel", resource.CopyrightLabel, htmlAttrs)
}
...
func (resource *OperationDefinition) T_Resource(numResource int, optionsValueSet []Coding, htmlAttrs string) templ.Component {
...
func (resource *OperationDefinition) T_ParameterScope(numParameter int, numScope int, htmlAttrs string) templ.Component {
	optionsValueSet := VSOperation_parameter_scope

	if resource == nil || numParameter >= len(resource.Parameter) || numScope >= len(resource.Parameter[numParameter].Scope) {
		return CodeSelect("OperationDefinition.Parameter."+strconv.Itoa(numParameter)+"..Scope."+strconv.Itoa(numScope)+".", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("OperationDefinition.Parameter."+strconv.Itoa(numParameter)+"..Scope."+strconv.Itoa(numScope)+".", &resource.Parameter[numParameter].Scope[numScope], optionsValueSet, htmlAttrs)
}
...
func (resource *OperationDefinition) T_ParameterType(numParameter int, htmlAttrs string) templ.Component {
...
func (resource *OperationDefinition) T_ParameterAllowedType(numParameter int, numAllowedType int, htmlAttrs string) templ.Component {
	optionsValueSet := VSFhir_types

	if resource == nil || numParameter >= len(resource.Parameter) || numAllowedType >= len(resource.Parameter[numParameter].AllowedType) {
		return CodeSelect("OperationDefinition.Parameter."+strconv.Itoa(numParameter)+"..AllowedType."+strconv.Itoa(numAllowedType)+".", nil, optionsValueSet, htmlAttrs)
	}
	return CodeSelect("OperationDefinition.Parameter."+strconv.Itoa(numParameter)+"..AllowedType."+strconv.Itoa(numAllowedType)+".", &resource.Parameter[numParameter].AllowedType[numAllowedType], optionsValueSet, htmlAttrs)
}
