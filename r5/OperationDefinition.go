...
func (resource *OperationDefinition) T_Copyright() templ.Component {

	if resource == nil {
		return StringInput("OperationDefinition.Copyright", nil)
	}
	return StringInput("OperationDefinition.Copyright", resource.Copyright)
}
func (resource *OperationDefinition) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("OperationDefinition.CopyrightLabel", nil)
	}
	return StringInput("OperationDefinition.CopyrightLabel", resource.CopyrightLabel)
}
...
func (resource *OperationDefinition) T_Resource(numResource int, optionsValueSet []Coding) templ.Component {
...
func (resource *OperationDefinition) T_ParameterScope(numParameter int, numScope int) templ.Component {
	optionsValueSet := VSOperation_parameter_scope

	if resource == nil || len(resource.Parameter) >= numParameter || len(resource.Parameter[numParameter].Scope) >= numScope {
		return CodeSelect("OperationDefinition.Parameter["+strconv.Itoa(numParameter)+"].Scope["+strconv.Itoa(numScope)+"]", nil, optionsValueSet)
	}
	return CodeSelect("OperationDefinition.Parameter["+strconv.Itoa(numParameter)+"].Scope["+strconv.Itoa(numScope)+"]", &resource.Parameter[numParameter].Scope[numScope], optionsValueSet)
}
...
func (resource *OperationDefinition) T_ParameterAllowedType(numParameter int, numAllowedType int) templ.Component {
	optionsValueSet := VSFhir_types

	if resource == nil || len(resource.Parameter) >= numParameter || len(resource.Parameter[numParameter].AllowedType) >= numAllowedType {
		return CodeSelect("OperationDefinition.Parameter["+strconv.Itoa(numParameter)+"].AllowedType["+strconv.Itoa(numAllowedType)+"]", nil, optionsValueSet)
	}
	return CodeSelect("OperationDefinition.Parameter["+strconv.Itoa(numParameter)+"].AllowedType["+strconv.Itoa(numAllowedType)+"]", &resource.Parameter[numParameter].AllowedType[numAllowedType], optionsValueSet)
}
