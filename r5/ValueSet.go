...
func (resource *ValueSet) T_CopyrightLabel() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.CopyrightLabel", nil)
	}
	return StringInput("ValueSet.CopyrightLabel", resource.CopyrightLabel)
}
func (resource *ValueSet) T_ApprovalDate() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.ApprovalDate", nil)
	}
	return StringInput("ValueSet.ApprovalDate", resource.ApprovalDate)
}
func (resource *ValueSet) T_LastReviewDate() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.LastReviewDate", nil)
	}
	return StringInput("ValueSet.LastReviewDate", resource.LastReviewDate)
}
func (resource *ValueSet) T_Topic(numTopic int, optionsValueSet []Coding) templ.Component {

	if resource == nil || len(resource.Topic) >= numTopic {
		return CodeableConceptSelect("ValueSet.Topic["+strconv.Itoa(numTopic)+"]", nil, optionsValueSet)
	}
	return CodeableConceptSelect("ValueSet.Topic["+strconv.Itoa(numTopic)+"]", &resource.Topic[numTopic], optionsValueSet)
}
...
func (resource *ValueSet) T_ComposeProperty(numProperty int) templ.Component {

	if resource == nil || len(resource.Compose.Property) >= numProperty {
		return StringInput("ValueSet.Compose.Property["+strconv.Itoa(numProperty)+"]", nil)
	}
	return StringInput("ValueSet.Compose.Property["+strconv.Itoa(numProperty)+"]", &resource.Compose.Property[numProperty])
}
...
func (resource *ValueSet) T_ComposeIncludeCopyright(numInclude int) templ.Component {

	if resource == nil || len(resource.Compose.Include) >= numInclude {
		return StringInput("ValueSet.Compose.Include["+strconv.Itoa(numInclude)+"].Copyright", nil)
	}
	return StringInput("ValueSet.Compose.Include["+strconv.Itoa(numInclude)+"].Copyright", resource.Compose.Include[numInclude].Copyright)
}
...
func (resource *ValueSet) T_ComposeIncludeConceptDesignationAdditionalUse(numInclude int, numConcept int, numDesignation int, numAdditionalUse int, optionsValueSet []Coding) templ.Component {

	if resource == nil || len(resource.Compose.Include) >= numInclude || len(resource.Compose.Include[numInclude].Concept) >= numConcept || len(resource.Compose.Include[numInclude].Concept[numConcept].Designation) >= numDesignation || len(resource.Compose.Include[numInclude].Concept[numConcept].Designation[numDesignation].AdditionalUse) >= numAdditionalUse {
		return CodingSelect("ValueSet.Compose.Include["+strconv.Itoa(numInclude)+"].Concept["+strconv.Itoa(numConcept)+"].Designation["+strconv.Itoa(numDesignation)+"].AdditionalUse["+strconv.Itoa(numAdditionalUse)+"]", nil, optionsValueSet)
	}
	return CodingSelect("ValueSet.Compose.Include["+strconv.Itoa(numInclude)+"].Concept["+strconv.Itoa(numConcept)+"].Designation["+strconv.Itoa(numDesignation)+"].AdditionalUse["+strconv.Itoa(numAdditionalUse)+"]", &resource.Compose.Include[numInclude].Concept[numConcept].Designation[numDesignation].AdditionalUse[numAdditionalUse], optionsValueSet)
}
...
func (resource *ValueSet) T_ExpansionNext() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.Expansion.Next", nil)
	}
	return StringInput("ValueSet.Expansion.Next", resource.Expansion.Next)
}
...
func (resource *ValueSet) T_ExpansionPropertyId(numProperty int) templ.Component {

	if resource == nil || len(resource.Expansion.Property) >= numProperty {
		return StringInput("ValueSet.Expansion.Property["+strconv.Itoa(numProperty)+"].Id", nil)
	}
	return StringInput("ValueSet.Expansion.Property["+strconv.Itoa(numProperty)+"].Id", resource.Expansion.Property[numProperty].Id)
}
func (resource *ValueSet) T_ExpansionPropertyCode(numProperty int, optionsValueSet []Coding) templ.Component {

	if resource == nil || len(resource.Expansion.Property) >= numProperty {
		return CodeSelect("ValueSet.Expansion.Property["+strconv.Itoa(numProperty)+"].Code", nil, optionsValueSet)
	}
	return CodeSelect("ValueSet.Expansion.Property["+strconv.Itoa(numProperty)+"].Code", &resource.Expansion.Property[numProperty].Code, optionsValueSet)
}
func (resource *ValueSet) T_ExpansionPropertyUri(numProperty int) templ.Component {

	if resource == nil || len(resource.Expansion.Property) >= numProperty {
		return StringInput("ValueSet.Expansion.Property["+strconv.Itoa(numProperty)+"].Uri", nil)
	}
	return StringInput("ValueSet.Expansion.Property["+strconv.Itoa(numProperty)+"].Uri", resource.Expansion.Property[numProperty].Uri)
}
...
func (resource *ValueSet) T_ExpansionContainsPropertyId(numContains int, numProperty int) templ.Component {

	if resource == nil || len(resource.Expansion.Contains) >= numContains || len(resource.Expansion.Contains[numContains].Property) >= numProperty {
		return StringInput("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].Id", nil)
	}
	return StringInput("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].Id", resource.Expansion.Contains[numContains].Property[numProperty].Id)
}
func (resource *ValueSet) T_ExpansionContainsPropertyCode(numContains int, numProperty int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.Expansion.Contains) >= numContains || len(resource.Expansion.Contains[numContains].Property) >= numProperty {
		return CodeSelect("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].Code", nil, optionsValueSet)
	}
	return CodeSelect("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].Code", &resource.Expansion.Contains[numContains].Property[numProperty].Code, optionsValueSet)
}
func (resource *ValueSet) T_ExpansionContainsPropertySubPropertyId(numContains int, numProperty int, numSubProperty int) templ.Component {

	if resource == nil || len(resource.Expansion.Contains) >= numContains || len(resource.Expansion.Contains[numContains].Property) >= numProperty || len(resource.Expansion.Contains[numContains].Property[numProperty].SubProperty) >= numSubProperty {
		return StringInput("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].SubProperty["+strconv.Itoa(numSubProperty)+"].Id", nil)
	}
	return StringInput("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].SubProperty["+strconv.Itoa(numSubProperty)+"].Id", resource.Expansion.Contains[numContains].Property[numProperty].SubProperty[numSubProperty].Id)
}
func (resource *ValueSet) T_ExpansionContainsPropertySubPropertyCode(numContains int, numProperty int, numSubProperty int, optionsValueSet []Coding) templ.Component {
	...
	if resource == nil || len(resource.Expansion.Contains) >= numContains || len(resource.Expansion.Contains[numContains].Property) >= numProperty || len(resource.Expansion.Contains[numContains].Property[numProperty].SubProperty) >= numSubProperty {
		return CodeSelect("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].SubProperty["+strconv.Itoa(numSubProperty)+"].Code", nil, optionsValueSet)
	}
	return CodeSelect("ValueSet.Expansion.Contains["+strconv.Itoa(numContains)+"].Property["+strconv.Itoa(numProperty)+"].SubProperty["+strconv.Itoa(numSubProperty)+"].Code", &resource.Expansion.Contains[numContains].Property[numProperty].SubProperty[numSubProperty].Code, optionsValueSet)
}
func (resource *ValueSet) T_ScopeId() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.Scope.Id", nil)
	}
	return StringInput("ValueSet.Scope.Id", resource.Scope.Id)
}
func (resource *ValueSet) T_ScopeInclusionCriteria() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.Scope.InclusionCriteria", nil)
	}
	return StringInput("ValueSet.Scope.InclusionCriteria", resource.Scope.InclusionCriteria)
}
func (resource *ValueSet) T_ScopeExclusionCriteria() templ.Component {

	if resource == nil {
		return StringInput("ValueSet.Scope.ExclusionCriteria", nil)
	}
	return StringInput("ValueSet.Scope.ExclusionCriteria", resource.Scope.ExclusionCriteria)
}
