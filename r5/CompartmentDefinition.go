...
func (resource *CompartmentDefinition) T_Title() templ.Component {

	if resource == nil {
		return StringInput("CompartmentDefinition.Title", nil)
	}
	return StringInput("CompartmentDefinition.Title", resource.Title)
}
...
func (resource *CompartmentDefinition) T_ResourceStartParam(numResource int) templ.Component {

	if resource == nil || len(resource.Resource) >= numResource {
		return StringInput("CompartmentDefinition.Resource["+strconv.Itoa(numResource)+"].StartParam", nil)
	}
	return StringInput("CompartmentDefinition.Resource["+strconv.Itoa(numResource)+"].StartParam", resource.Resource[numResource].StartParam)
}
func (resource *CompartmentDefinition) T_ResourceEndParam(numResource int) templ.Component {

	if resource == nil || len(resource.Resource) >= numResource {
		return StringInput("CompartmentDefinition.Resource["+strconv.Itoa(numResource)+"].EndParam", nil)
	}
	return StringInput("CompartmentDefinition.Resource["+strconv.Itoa(numResource)+"].EndParam", resource.Resource[numResource].EndParam)
}
