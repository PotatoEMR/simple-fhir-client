...
func (resource *Subscription) T_Name(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Subscription) T_Topic(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Subscription) T_ChannelType(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Subscription) T_Endpoint(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return StringInput("endpoint", nil, htmlAttrs)
	}
	return StringInput("endpoint", resource.Endpoint, htmlAttrs)
}
func (resource *Subscription) T_HeartbeatPeriod(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return IntInput("heartbeatPeriod", nil, htmlAttrs)
	}
	return IntInput("heartbeatPeriod", resource.HeartbeatPeriod, htmlAttrs)
}
func (resource *Subscription) T_Timeout(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return IntInput("timeout", nil, htmlAttrs)
	}
	return IntInput("timeout", resource.Timeout, htmlAttrs)
}
func (resource *Subscription) T_ContentType(optionsValueSet []Coding, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
...
func (resource *Subscription) T_Content(htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Subscription) T_MaxCount(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return IntInput("maxCount", nil, htmlAttrs)
	}
	return IntInput("maxCount", resource.MaxCount, htmlAttrs)
}
func (resource *Subscription) T_FilterByResourceType(numFilterBy int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Subscription) T_FilterByFilterParameter(numFilterBy int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numFilterBy >= len(resource.FilterBy) {
...
func (resource *Subscription) T_FilterByComparator(numFilterBy int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Subscription) T_FilterByModifier(numFilterBy int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Subscription) T_FilterByValue(numFilterBy int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numFilterBy >= len(resource.FilterBy) {
...
func (resource *Subscription) T_ParameterName(numParameter int, htmlAttrs templ.Attributes) templ.Component {
...
func (resource *Subscription) T_ParameterValue(numParameter int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numParameter >= len(resource.Parameter) {
