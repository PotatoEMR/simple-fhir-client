...
func (resource *ClinicalUseDefinition) T_ContraindicationApplicability(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ExpressionInput("contraindication.applicability", nil, htmlAttrs)
	}
	return ExpressionInput("contraindication.applicability", resource.Contraindication.Applicability, htmlAttrs)
}
...
func (resource *ClinicalUseDefinition) T_ContraindicationOtherTherapyTreatment(numOtherTherapy int, htmlAttrs templ.Attributes) templ.Component {
	if resource == nil || numOtherTherapy >= len(resource.Contraindication.OtherTherapy) {
		return CodeableReferenceInput("contraindication.otherTherapy["+strconv.Itoa(numOtherTherapy)+"].treatment", nil, htmlAttrs)
	}
	return CodeableReferenceInput("contraindication.otherTherapy["+strconv.Itoa(numOtherTherapy)+"].treatment", &resource.Contraindication.OtherTherapy[numOtherTherapy].Treatment, htmlAttrs)
}
...
func (resource *ClinicalUseDefinition) T_IndicationApplicability(htmlAttrs templ.Attributes) templ.Component {
	if resource == nil {
		return ExpressionInput("indication.applicability", nil, htmlAttrs)
	}
	return ExpressionInput("indication.applicability", resource.Indication.Applicability, htmlAttrs)
}
